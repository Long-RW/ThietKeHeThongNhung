...
#define LCD_ENTRYMODESET							0x04	//Set moving direction of cursor, Appoint if move
#define LCD_DISPLAYCONTROL						0x08	//Set display on/off, cursor on/off, bink on/off
#define LCD_CURSORSHIFT								0x10	//Remove curosr and whole display, DDRAM changeless
#define LCD_FUNCTIONSET								0x20
#define LCD_SETCGRAMADDR							0x40
#define LCD_SETDDRAMADDR							0x80

//flag for display entry mode
#define LCD_ENTRYRIGHT								0x00
#define LCD_ENTRYLEFT									0x02
#define LCD_ENTRYSHIFTINCREMENT				0x01
#define LCD_ENTRYSHIFTDECREMENT				0x00

//falg for display on/off control
...
#define LCD_5x10DOTS									0x04	//font
#define LCD_5x8DOTS										0x00	//font
typedef struct
{
	uint8_t MODE;
	uint8_t COLUMS;
